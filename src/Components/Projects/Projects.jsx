            ...
            <motion.div
                ...
                <div className="parent">
                    ...
                    <div className="card">
                        ...
                        <p>
                            in this website i show all medical tool that doctors need .as commerce website 
                            i use react js ,react-router-dom,framr-motion library,usestate hook ,useParams, 
                        </p>
                        <div className="icon">
